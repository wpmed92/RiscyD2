...
def run_test(test_case):
    ...
    run_command += "iverilog -o ../../test/test.chip riscyd2_soc.v alu.v execute.v multiplier.v divider.v csr_rf.v decode.v gpio.v mem.v mmio.v rf.v uart_rx.v uart_tx.v ../../test/test.v ;"
    run_command += "cd ../../test ;"
